          ...
          if ($('#email').val() !== '' && $('#username').val() !== '' && $('#subject').val() !== '' && $('#topic').val() !== '' && $('#timeslot').val() !== '') {
            ...
            $.post(TAG.Challenge.registerURL,
              ...
              function(response) {
                ...
                console.log('TAG.Challenge.registeredTopics before push');
                console.log(TAG.Challenge.registeredTopics);
                if (response.status === 'registered') {
                  TAG.Challenge.clearForm();
                  let newTopic = {};
                  newTopic.weight = weight;
                  newTopic.username = username;
                  newTopic.email = email;
                  newTopic.subject = subject.name;
                  newTopic.topic = topic.name;
                  newTopic.timeslot = timeslot.name;
                  TAG.Challenge.registeredTopics.push(newTopic);
                }
                console.log('TAG.Challenge.registeredTopics after push');
                console.log(TAG.Challenge.registeredTopics);
              }
            );
          }
      ...
      TAG.Challenge.subjectChanged = function () {
        $(context).on('change', TAG.Challenge.subjectSelector, function (e) {
          ...
          if ($subjectInputValue !== '') {
            ...
            console.log($subjectInputValue);
            console.log('TAG.Challenge.subjects.$subjectInputValue.topics');
            console.log(TAG.Challenge.subjects[$subjectInputValue].topics);
      ...
      TAG.Challenge.topicChanged = function () {
        $(context).on('change', TAG.Challenge.topicSelector, function (e) {
          ...
          if ($topicInputValue !== '') {
            ...
            console.log($topicInputValue);
            console.log('TAG.Challenge.topics.$topicInputValue.topics');
            console.log(TAG.Challenge.topics[$topicInputValue].times);
      ...
      TAG.Challenge.timeslotChanged = function () {
        $(context).on('change', TAG.Challenge.timeslotSelector, function (e) {
          ...
          if ($timeslotInputValue !== '') { 
            ...
            console.log('selected timeslot tag');
            console.log($optionSelectedEl.data('timeslot-tag'));
