    ...
    attach: function attach(context) {
        ...
        $(context).on('click', TAG.Challenge.submitButtonSelector, function (e) {
          if ($('#email').val() !== '' && $('#username').val() !== '') {
            ...
            $.post(TAG.Challenge.registerURL,
              {category:'client', type:'premium', username: 'joshua f.'},
              function(response) {
                console.log('success');
      ...
      TAG.Challenge.subjectChanged = function () {
        $(context).on('change', TAG.Challenge.subjectSelector, function (e) {
          const $subjectInputValue = $(TAG.Challenge.subjectSelector).val();
          const $topicInput = $(TAG.Challenge.topicSelector);
          const partial = TRUE;

          TAG.Challenge.clearForm(partial);
          console.log('subjectInputValue');
          console.log($subjectInputValue);
          console.log('drupalSettings.subjects.$subjectInputValue.topics');
          console.log(drupalSettings.subjects[$subjectInputValue].topics);
          $.each(drupalSettings.subjects[$subjectInputValue].topics, function() {
            $topicInput.append($("<option />").val(this.value).text(this.name));
          });
          // $subjectInput.append($("<option />").val(drupalSettings.$subjectInputValue).text(this.Name));
        });
      };
      ...
      TAG.Challenge.topicChanged = function () {
        $(context).on('change', TAG.Challenge.topicSelector, function (e) {
          ...
          console.log($topicInputValue);
          console.log('drupalSettings.topics.$topicInputValue.topics');
          console.log(drupalSettings.topics[$topicInputValue].times);
          $.each(drupalSettings.topics[$topicInputValue].times, function() {
            $timeslotInput.append($("<option />").val(this.weight).text(this.time));
          });
          // $subjectInput.append($("<option />").val(drupalSettings.$subjectInputValue).text(this.Name));
        });
      };

      TAG.Challenge.clearForm = function (partial = FALSE) {
